...
public class XYZSeriesDialog extends javax.swing.JDialog {
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        ...
        xValueExpression = Misc.createExpression("java.lang.Number",  jRTextExpressionXValue.getText());
        yValueExpression =  Misc.createExpression("java.lang.Number",  jRTextExpressionYValue.getText());
        zValueExpression =  Misc.createExpression("java.lang.Number",  jRTextExpressionZValue.getText());
        ...
        if (xValueExpression == null) {
           javax.swing.JOptionPane.showMessageDialog(this, formatter.format(new Object[]{"X Value expression"}) ,"Invalid expression",javax.swing.JOptionPane.ERROR_MESSAGE);
           return;
        }  
        
        if (yValueExpression == null) {
           javax.swing.JOptionPane.showMessageDialog(this, formatter.format(new Object[]{"Y Value expression"}) ,"Invalid expression",javax.swing.JOptionPane.ERROR_MESSAGE);
           return;
        } 
