...
public class TimeSeriesDatasetPanel extends javax.swing.JPanel implements ChartDatasetPanel {
    ...
    public TimeSeriesDatasetPanel() {
        ...
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Year"),"Year"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Quarter"),"Quarter"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Month"),"Month"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Week"),"Week"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Day"),"Day"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Hour"),"Hour"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Minute"),"Minute"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Second"),"Second"));
        this.jComboBoxPeriod.addItem(new Tag(JRXmlConstants.getTimePeriod("Milisecond"),"Milisecond"));
    ...
    public void setTimeSeriesDataset(JRDesignTimeSeriesDataset timeSeriesDataset) {
        ...
        Misc.setComboboxSelectedTagValue(jComboBoxPeriod, timeSeriesDataset.getTimePeriod() == null ? JRXmlConstants.getTimePeriod("Day") : timeSeriesDataset.getTimePeriod() );
        init = false;
    }
