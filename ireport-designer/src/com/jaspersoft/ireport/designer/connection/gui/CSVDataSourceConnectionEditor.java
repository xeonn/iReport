...
public class CSVDataSourceConnectionEditor extends javax.swing.JPanel implements IReportConnectionEditor {
    ...
    public IReportConnection getIReportConnection() {
        ...
        IReportConnection irConn = new JRCSVDataSourceConnection();
            ...
            {
                if (JOptionPane.showConfirmDialog(this,"You have not defined any column for your CSV file. Continue anyway?","",JOptionPane.INFORMATION_MESSAGE) != JOptionPane.OK_OPTION) //"messages.connectionDialog.notAllColumnsDefined"
                {
                    return null;
                }
            }
            ...
            {
                if (JOptionPane.showConfirmDialog(this,"Field delimiter char is the same as the record delimiter. Continue anyway?","",JOptionPane.INFORMATION_MESSAGE) != JOptionPane.OK_OPTION) //"messages.connectionDialog.duplicatedDelimiter"
                {
                    return null;
                } 
            }
...
// TODO add your handling code here:
    ...
    private void jButtonNewParameterActionPerformed11(java.awt.event.ActionEvent evt) {                                                      
        ...
        {
            JOptionPane.showMessageDialog(this,ex.getMessage(), "Exception", JOptionPane.ERROR_MESSAGE); //"message.title.exception"
        }
    ...
    private void jButtonModifyParameterActionPerformed1(java.awt.event.ActionEvent evt) {                                                        
        ...
        String name = JOptionPane.showInputDialog(this, "Column name", oldName); //"connectionDialog.input.columnName"
    ...
    private void jButtonNewParameterActionPerformed1(java.awt.event.ActionEvent evt) {                                                     
        ...
        DefaultListModel dlm = (DefaultListModel)jListCVSColumns.getModel();
        String name = JOptionPane.showInputDialog(this, "Column name", "COLUMN_" + dlm.getSize()); //"connectionDialog.input.columnName"
