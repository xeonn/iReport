 ...
 */
public final class BubbleXAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignBubblePlot element;
        
        @SuppressWarnings("unchecked")
        public BubbleXAxisTickLabelFontProperty(JRDesignBubblePlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignBubblePlot.PROPERTY_X_AXIS_TICK_LABEL_FONT, "X Axis Tick Label Font", "X Axis Tick Label Font", jd);
