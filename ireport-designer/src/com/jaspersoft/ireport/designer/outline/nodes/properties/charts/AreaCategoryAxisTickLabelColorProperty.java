 ...
 */
public final class AreaCategoryAxisTickLabelColorProperty extends PropertySupport.ReadWrite {

    JRDesignAreaPlot element = null;

    @SuppressWarnings("unchecked")
    public AreaCategoryAxisTickLabelColorProperty(JRDesignAreaPlot element)
    {
        super(JRDesignAreaPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_COLOR, java.awt.Color.class,
              "Category Axis Tick Label Color",
              "The color of the Category Axis Tick Label.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnCategoryAxisTickLabelColor();
            Color newValue =  (Color)val;
            element.setCategoryAxisTickLabelColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnCategoryAxisTickLabelColor();
    }
