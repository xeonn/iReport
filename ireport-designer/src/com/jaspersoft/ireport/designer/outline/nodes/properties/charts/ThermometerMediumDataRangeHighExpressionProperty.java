...
public final class ThermometerMediumDataRangeHighExpressionProperty extends ExpressionProperty {
    ...
    public ThermometerMediumDataRangeHighExpressionProperty(JRDesignThermometerPlot element, JRDesignDataset dataset)
    {
        super("MEDIUM_RANGE_" + JRDesignDataRange.PROPERTY_HIGH_EXPRESSION,
              "Medium Data Range High Expression",
              "Medium Data Range High Expression");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        if (element.getMediumRange() == null) return "";
        if (element.getMediumRange().getHighExpression() == null) return "";
        if (element.getMediumRange().getHighExpression().getText() == null) return "";
        return element.getMediumRange().getHighExpression().getText();
    }

    @Override
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {

        JRDataRange oldValue =  element.getMediumRange();
        ...
        try {
            element.setMediumRange(newValue);
