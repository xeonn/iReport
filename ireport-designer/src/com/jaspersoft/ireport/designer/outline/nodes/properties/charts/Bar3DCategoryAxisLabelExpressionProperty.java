...
public final class Bar3DCategoryAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public Bar3DCategoryAxisLabelExpressionProperty(JRDesignBar3DPlot element, JRDesignDataset dataset)
    {
        super(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_LABEL_EXPRESSION,
