 ...
 */
public final class TimeSeriesValueAxisLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignTimeSeriesPlot element;
        
        @SuppressWarnings("unchecked")
        public TimeSeriesValueAxisLabelFontProperty(JRDesignTimeSeriesPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignTimeSeriesPlot.PROPERTY_VALUE_AXIS_LABEL_FONT, "Value Axis Label Font", "Value Axis Label Font", jd);
