 ...
 */
public final class ScatterYAxisLabelColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignScatterPlot.PROPERTY_Y_AXIS_LABEL_COLOR, java.awt.Color.class,
              "Y Axis Label Color",
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnYAxisLabelColor();
            Color newValue =  (Color)val;
            element.setYAxisLabelColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnYAxisLabelColor();
    }
