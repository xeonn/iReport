 ...
 */
public final class MeterTickIntervalProperty extends PropertySupport.ReadWrite {

    JRDesignMeterPlot element = null;

    @SuppressWarnings("unchecked")
    public MeterTickIntervalProperty(JRDesignMeterPlot element)
    {
        super(JRDesignMeterPlot.PROPERTY_TICK_INTERVAL, Double.class,
              "Tick Interval",
              "Tick Interval");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        return element.getTickInterval();
    }
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            double oldValue = element.getTickInterval();
            double newValue =  ((Double)val).doubleValue();
            
            element.setTickInterval(newValue);
