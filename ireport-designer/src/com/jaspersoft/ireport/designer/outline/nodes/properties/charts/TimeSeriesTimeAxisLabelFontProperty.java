 ...
 */
public final class TimeSeriesTimeAxisLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignTimeSeriesPlot element;
        
        @SuppressWarnings("unchecked")
        public TimeSeriesTimeAxisLabelFontProperty(JRDesignTimeSeriesPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignTimeSeriesPlot.PROPERTY_TIME_AXIS_LABEL_FONT, "Time Axis Label Font", "Time Axis Label Font", jd);
