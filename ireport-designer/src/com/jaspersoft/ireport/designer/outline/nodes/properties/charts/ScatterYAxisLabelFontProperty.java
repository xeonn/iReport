 ...
 */
public final class ScatterYAxisLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignScatterPlot element;
        
        @SuppressWarnings("unchecked")
        public ScatterYAxisLabelFontProperty(JRDesignScatterPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignScatterPlot.PROPERTY_Y_AXIS_LABEL_FONT, "Y Axis Label Font", "Y Axis Label Font", jd);
    ...
    @Override
        public Object getValue() throws IllegalAccessException, InvocationTargetException {
            return element.getYAxisLabelFont();
        }
    ...
    @Override
        public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            {
                JRDesignFont oldValue = (JRDesignFont)element.getYAxisLabelFont();
                JRDesignFont newValue = (JRDesignFont)val;
                element.setYAxisLabelFont(newValue);
        ...
        public boolean isDefaultValue() {
            return null == element.getYAxisLabelFont();
        }
