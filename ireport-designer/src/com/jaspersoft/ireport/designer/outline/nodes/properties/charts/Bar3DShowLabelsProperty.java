 ...
 */
public final class Bar3DShowLabelsProperty extends PropertySupport.ReadWrite {

    private final JRDesignBar3DPlot element;

    @SuppressWarnings("unchecked")
    public Bar3DShowLabelsProperty(JRDesignBar3DPlot element)
    {
        super(JRDesignBar3DPlot.PROPERTY_SHOW_LABELS, Boolean.class,
              "Show Labels",
              "Show Labels");
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowLabels();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowLabels(newValue);
