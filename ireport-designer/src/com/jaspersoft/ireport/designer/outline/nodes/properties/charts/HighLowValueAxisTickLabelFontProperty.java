 ...
 */
public final class HighLowValueAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignHighLowPlot element;
        
        @SuppressWarnings("unchecked")
        public HighLowValueAxisTickLabelFontProperty(JRDesignHighLowPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignHighLowPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, "Value Axis Tick Label Font", "Value Axis Tick Label Font", jd);
