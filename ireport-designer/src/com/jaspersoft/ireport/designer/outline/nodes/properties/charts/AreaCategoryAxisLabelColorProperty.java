 ...
 */
public final class AreaCategoryAxisLabelColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignAreaPlot.PROPERTY_CATEGORY_AXIS_LABEL_COLOR, java.awt.Color.class,
              "Category Axis Label Color",
              "The color of the Category Axis Label.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnCategoryAxisLabelColor();
            Color newValue =  (Color)val;
            element.setCategoryAxisLabelColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnCategoryAxisLabelColor();
    }
