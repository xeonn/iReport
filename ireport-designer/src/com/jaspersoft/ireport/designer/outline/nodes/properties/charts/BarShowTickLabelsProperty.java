 ...
 */
public final class BarShowTickLabelsProperty extends PropertySupport.ReadWrite {

    private final JRDesignBarPlot element;

    @SuppressWarnings("unchecked")
    public BarShowTickLabelsProperty(JRDesignBarPlot element)
    {
        super(JRDesignBarPlot.PROPERTY_SHOW_TICK_LABELS, Boolean.class,
              "Show Tick Labels",
              "Show Tick Labels");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        return element.isShowTickLabels();
    }
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowTickMarks();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowTickLabels(newValue);
