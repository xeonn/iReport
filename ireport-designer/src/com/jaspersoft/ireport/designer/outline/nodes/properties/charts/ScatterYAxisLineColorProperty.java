 ...
 */
public final class ScatterYAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignScatterPlot.PROPERTY_Y_AXIS_LINE_COLOR, java.awt.Color.class,
              "Y Axis Scatter Color",
              "The color of the Y Axis Scatter.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnYAxisLineColor();
            Color newValue =  (Color)val;
            element.setYAxisLineColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnYAxisLineColor();
    }
