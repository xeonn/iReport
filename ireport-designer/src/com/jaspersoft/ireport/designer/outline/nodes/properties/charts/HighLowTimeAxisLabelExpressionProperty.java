...
public final class HighLowTimeAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public HighLowTimeAxisLabelExpressionProperty(JRDesignHighLowPlot element, JRDesignDataset dataset)
    {
        super(JRDesignHighLowPlot.PROPERTY_TIME_AXIS_LABEL_EXPRESSION,
