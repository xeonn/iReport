...
/**
 *  Class to manage the JRDesignChart.PROPERTY_LEGEND_COLOR property
 */
public final class LegendBackgroundColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRBaseChart.PROPERTY_LEGEND_BACKGROUND_COLOR, java.awt.Color.class,
              "Legend Background",
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnLegendBackgroundColor();
            Color newValue =  (Color)val;
            element.setLegendBackgroundColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnLegendBackgroundColor();
    }
