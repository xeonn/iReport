 ...
 */
public final class BarValueAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignBarPlot element;
        
        @SuppressWarnings("unchecked")
        public BarValueAxisTickLabelFontProperty(JRDesignBarPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, "Value Axis Tick Label Font", "Value Axis Tick Label Font", jd);
