 ...
 */
public final class AreaCategoryAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignAreaPlot element;
    
        @SuppressWarnings("unchecked")
        public AreaCategoryAxisTickLabelMaskProperty(JRDesignAreaPlot element)
        {
            super(JRDesignAreaPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_MASK,
                    String.class, 
