 ...
 */
public final class TimeSeriesValueAxisLineColorProperty extends PropertySupport.ReadWrite {

    JRDesignTimeSeriesPlot element = null;

    @SuppressWarnings("unchecked")
    public TimeSeriesValueAxisLineColorProperty(JRDesignTimeSeriesPlot element)
    {
        super(JRDesignTimeSeriesPlot.PROPERTY_VALUE_AXIS_LINE_COLOR, java.awt.Color.class,
              "Value Axis TimeSeries Color",
              "The color of the Value Axis TimeSeries.");
