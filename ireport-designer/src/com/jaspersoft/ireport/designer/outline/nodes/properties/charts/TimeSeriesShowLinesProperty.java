 ...
 */
public final class TimeSeriesShowLinesProperty extends PropertySupport.ReadWrite {

    private final JRDesignTimeSeriesPlot element;

    @SuppressWarnings("unchecked")
    public TimeSeriesShowLinesProperty(JRDesignTimeSeriesPlot element)
    {
        super(JRDesignTimeSeriesPlot.PROPERTY_SHOW_LINES, Boolean.class,
              "Show Lines",
              "Show Lines");
