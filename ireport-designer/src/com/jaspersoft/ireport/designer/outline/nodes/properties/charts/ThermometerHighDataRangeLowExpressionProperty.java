...
public final class ThermometerHighDataRangeLowExpressionProperty extends ExpressionProperty {
    ...
    public ThermometerHighDataRangeLowExpressionProperty(JRDesignThermometerPlot element, JRDesignDataset dataset)
    {
        super("HIGH_RANGE_" + JRDesignDataRange.PROPERTY_LOW_EXPRESSION,
              "High Data Range Low Expression",
              "High Data Range Low Expression");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        ...
        if (element.getHighRange().getLowExpression() == null) return "";
        if (element.getHighRange().getLowExpression().getText() == null) return "";
        return element.getHighRange().getLowExpression().getText();
    }
