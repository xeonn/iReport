 ...
 */
public final class LineCategoryAxisTickLabelColorProperty extends PropertySupport.ReadWrite {

    JRDesignLinePlot element = null;

    @SuppressWarnings("unchecked")
    public LineCategoryAxisTickLabelColorProperty(JRDesignLinePlot element)
    {
        super(JRDesignLinePlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_COLOR, java.awt.Color.class,
