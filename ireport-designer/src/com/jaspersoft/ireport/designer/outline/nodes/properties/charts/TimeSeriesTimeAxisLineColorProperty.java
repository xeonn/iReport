 ...
 */
public final class TimeSeriesTimeAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignTimeSeriesPlot.PROPERTY_TIME_AXIS_LINE_COLOR, java.awt.Color.class,
              "Time Axis TimeSeries Color",
              "The color of the Time Axis TimeSeries.");
