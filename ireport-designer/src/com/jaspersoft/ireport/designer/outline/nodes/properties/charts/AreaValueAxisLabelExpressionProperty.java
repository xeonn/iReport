...
public final class AreaValueAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public AreaValueAxisLabelExpressionProperty(JRDesignAreaPlot element, JRDesignDataset dataset)
    {
        super(JRDesignAreaPlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION,
