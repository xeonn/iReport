 ...
 */
public final class ScatterXAxisLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignScatterPlot element;
        
        @SuppressWarnings("unchecked")
        public ScatterXAxisLabelFontProperty(JRDesignScatterPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignScatterPlot.PROPERTY_X_AXIS_LABEL_FONT, "X Axis Label Font", "X Axis Label Font", jd);
    ...
    @Override
        public Object getValue() throws IllegalAccessException, InvocationTargetException {
            return element.getXAxisLabelFont();
        }
    ...
    @Override
        public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            {
                JRDesignFont oldValue = (JRDesignFont)element.getXAxisLabelFont();
                JRDesignFont newValue = (JRDesignFont)val;
                element.setXAxisLabelFont(newValue);
        ...
        public boolean isDefaultValue() {
            return null == element.getXAxisLabelFont();
        }
