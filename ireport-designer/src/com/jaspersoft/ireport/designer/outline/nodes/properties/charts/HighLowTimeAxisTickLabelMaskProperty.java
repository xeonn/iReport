 ...
 */
public final class HighLowTimeAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignHighLowPlot element;
    
        @SuppressWarnings("unchecked")
        public HighLowTimeAxisTickLabelMaskProperty(JRDesignHighLowPlot element)
        {
            super(JRDesignHighLowPlot.PROPERTY_TIME_AXIS_TICK_LABEL_MASK,
                    String.class, 
