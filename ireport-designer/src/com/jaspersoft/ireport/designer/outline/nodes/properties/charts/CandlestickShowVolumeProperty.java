 ...
 */
public final class CandlestickShowVolumeProperty extends PropertySupport.ReadWrite {

    private final JRDesignCandlestickPlot element;

    @SuppressWarnings("unchecked")
    public CandlestickShowVolumeProperty(JRDesignCandlestickPlot element)
    {
        super(JRDesignCandlestickPlot.PROPERTY_SHOW_VOLUME, Boolean.class,
              "Show Volume",
              "Show Volume");
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowVolume();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowVolume(newValue);
