 ...
 */
public final class CandlestickTimeAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignCandlestickPlot element;
        
        @SuppressWarnings("unchecked")
        public CandlestickTimeAxisTickLabelFontProperty(JRDesignCandlestickPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_FONT, "Time Axis Tick Label Font", "Time Axis Tick Label Font", jd);
