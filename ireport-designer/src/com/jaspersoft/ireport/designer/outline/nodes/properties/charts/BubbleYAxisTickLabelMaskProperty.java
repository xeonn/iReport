 ...
 */
public final class BubbleYAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignBubblePlot element;
    
        @SuppressWarnings("unchecked")
        public BubbleYAxisTickLabelMaskProperty(JRDesignBubblePlot element)
        {
            super(JRDesignBubblePlot.PROPERTY_Y_AXIS_TICK_LABEL_MASK,
                    String.class, 
