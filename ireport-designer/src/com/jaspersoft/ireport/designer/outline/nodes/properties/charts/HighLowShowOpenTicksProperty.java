 ...
 */
public final class HighLowShowOpenTicksProperty extends PropertySupport.ReadWrite {

    private final JRDesignHighLowPlot element;

    @SuppressWarnings("unchecked")
    public HighLowShowOpenTicksProperty(JRDesignHighLowPlot element)
    {
        super(JRDesignHighLowPlot.PROPERTY_SHOW_OPEN_TICKS, Boolean.class,
              "Show OpenTicks",
              "Show OpenTicks");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        return element.isShowOpenTicks();
    }
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowOpenTicks();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowOpenTicks(newValue);
