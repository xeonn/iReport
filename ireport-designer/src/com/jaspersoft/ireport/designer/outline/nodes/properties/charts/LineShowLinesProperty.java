 ...
 */
public final class LineShowLinesProperty extends PropertySupport.ReadWrite {

    private final JRDesignLinePlot element;

    @SuppressWarnings("unchecked")
    public LineShowLinesProperty(JRDesignLinePlot element)
    {
        super(JRDesignLinePlot.PROPERTY_SHOW_LINES, Boolean.class,
              "Show Lines",
              "Show Lines");
