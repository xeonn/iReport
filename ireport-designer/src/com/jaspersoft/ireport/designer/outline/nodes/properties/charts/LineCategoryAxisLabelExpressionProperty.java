...
public final class LineCategoryAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public LineCategoryAxisLabelExpressionProperty(JRDesignLinePlot element, JRDesignDataset dataset)
    {
        super(JRDesignLinePlot.PROPERTY_CATEGORY_AXIS_LABEL_EXPRESSION,
