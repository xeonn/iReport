 ...
 */
public final class Bar3DYOffsetProperty extends PropertySupport.ReadWrite {

    JRDesignBar3DPlot element = null;

    @SuppressWarnings("unchecked")
    public Bar3DYOffsetProperty(JRDesignBar3DPlot element)
    {
        super(JRDesignBar3DPlot.PROPERTY_Y_OFFSET, Double.class,
              "Y Offset",
              "Y Offset");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            double oldValue = element.getYOffset();
            double newValue =  ((Double)val).doubleValue();
            
            element.setYOffset(newValue);
