 ...
 */
public final class TimeSeriesValueAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignTimeSeriesPlot element;
        
        @SuppressWarnings("unchecked")
        public TimeSeriesValueAxisTickLabelFontProperty(JRDesignTimeSeriesPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignTimeSeriesPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, "Value Axis Tick Label Font", "Value Axis Tick Label Font", jd);
