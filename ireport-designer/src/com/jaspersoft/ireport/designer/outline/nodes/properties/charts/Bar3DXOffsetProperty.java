 ...
 */
public final class Bar3DXOffsetProperty extends PropertySupport.ReadWrite {

    JRDesignBar3DPlot element = null;

    @SuppressWarnings("unchecked")
    public Bar3DXOffsetProperty(JRDesignBar3DPlot element)
    {
        super(JRDesignBar3DPlot.PROPERTY_X_OFFSET, Double.class,
              "X Offset",
              "X Offset");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            double oldValue = element.getXOffset();
            double newValue =  ((Double)val).doubleValue();
            
            element.setXOffset(newValue);
