 ...
 */
public final class ScatterXAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignScatterPlot element;
        
        @SuppressWarnings("unchecked")
        public ScatterXAxisTickLabelFontProperty(JRDesignScatterPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignScatterPlot.PROPERTY_X_AXIS_TICK_LABEL_FONT, "X Axis Tick Label Font", "X Axis Tick Label Font", jd);
    ...
    @Override
        public Object getValue() throws IllegalAccessException, InvocationTargetException {
            return element.getXAxisTickLabelFont();
        }
    ...
    @Override
        public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            {
                JRDesignFont oldValue = (JRDesignFont)element.getXAxisTickLabelFont();
                JRDesignFont newValue = (JRDesignFont)val;
                element.setXAxisTickLabelFont(newValue);
        ...
        public boolean isDefaultValue() {
            return null == element.getXAxisTickLabelFont();
        }
