 ...
 */
public final class CandlestickValueAxisLineColorProperty extends PropertySupport.ReadWrite {

    JRDesignCandlestickPlot element = null;

    @SuppressWarnings("unchecked")
    public CandlestickValueAxisLineColorProperty(JRDesignCandlestickPlot element)
    {
        super(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LINE_COLOR, java.awt.Color.class,
              "Value Axis Candlestick Color",
              "The color of the Value Axis Candlestick.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnValueAxisLineColor();
            Color newValue =  (Color)val;
            element.setValueAxisLineColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnValueAxisLineColor();
    }
