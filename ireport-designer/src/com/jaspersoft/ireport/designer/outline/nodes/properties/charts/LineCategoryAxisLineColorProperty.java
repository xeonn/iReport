 ...
 */
public final class LineCategoryAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignLinePlot.PROPERTY_CATEGORY_AXIS_LINE_COLOR, java.awt.Color.class,
              "Category Axis Line Color",
              "The color of the Category Axis Line.");
