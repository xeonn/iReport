 ...
 */
public final class AreaValueAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignAreaPlot.PROPERTY_VALUE_AXIS_LINE_COLOR, java.awt.Color.class,
              "Value Axis Area Color",
              "The color of the Value Axis Area.");
