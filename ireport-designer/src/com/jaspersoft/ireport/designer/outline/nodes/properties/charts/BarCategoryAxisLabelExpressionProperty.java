...
public final class BarCategoryAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public BarCategoryAxisLabelExpressionProperty(JRDesignBarPlot element, JRDesignDataset dataset)
    {
        super(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LABEL_EXPRESSION,
