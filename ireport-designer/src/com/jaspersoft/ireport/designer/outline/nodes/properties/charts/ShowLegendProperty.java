 ...
 */
public final class ShowLegendProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRBaseChart.PROPERTY_SHOW_LEGEND, Boolean.class,
              "Show Ledend",
              "Show Ledend");
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowLegend();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowLegend(newValue);
    ...
    public boolean isDefaultValue() {
        return element.isShowLegend() == true;
    }
