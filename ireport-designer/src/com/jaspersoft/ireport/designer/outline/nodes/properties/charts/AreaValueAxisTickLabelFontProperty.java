 ...
 */
public final class AreaValueAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignAreaPlot element;
        
        @SuppressWarnings("unchecked")
        public AreaValueAxisTickLabelFontProperty(JRDesignAreaPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignAreaPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, "Value Axis Tick Label Font", "Value Axis Tick Label Font", jd);
