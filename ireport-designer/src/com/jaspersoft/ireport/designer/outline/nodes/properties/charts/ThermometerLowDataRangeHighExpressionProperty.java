...
public final class ThermometerLowDataRangeHighExpressionProperty extends ExpressionProperty {
    ...
    public ThermometerLowDataRangeHighExpressionProperty(JRDesignThermometerPlot element, JRDesignDataset dataset)
    {
        super("LOW_RANGE_" + JRDesignDataRange.PROPERTY_HIGH_EXPRESSION,
              "Low Data Range High Expression",
              "Low Data Range High Expression");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        ...
        if (element.getLowRange().getHighExpression() == null) return "";
        if (element.getLowRange().getHighExpression().getText() == null) return "";
        return element.getLowRange().getHighExpression().getText();
    }
