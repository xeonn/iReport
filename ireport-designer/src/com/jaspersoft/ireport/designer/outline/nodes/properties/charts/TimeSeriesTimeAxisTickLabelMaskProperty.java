 ...
 */
public final class TimeSeriesTimeAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignTimeSeriesPlot element;
    
        @SuppressWarnings("unchecked")
        public TimeSeriesTimeAxisTickLabelMaskProperty(JRDesignTimeSeriesPlot element)
        {
            super(JRDesignTimeSeriesPlot.PROPERTY_TIME_AXIS_TICK_LABEL_MASK,
                    String.class, 
