...
public final class CandlestickTimeAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public CandlestickTimeAxisLabelExpressionProperty(JRDesignCandlestickPlot element, JRDesignDataset dataset)
    {
        super(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_EXPRESSION,
