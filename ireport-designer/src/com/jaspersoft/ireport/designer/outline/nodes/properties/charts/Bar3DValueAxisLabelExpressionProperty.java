...
public final class Bar3DValueAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public Bar3DValueAxisLabelExpressionProperty(JRDesignBar3DPlot element, JRDesignDataset dataset)
    {
        super(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION,
