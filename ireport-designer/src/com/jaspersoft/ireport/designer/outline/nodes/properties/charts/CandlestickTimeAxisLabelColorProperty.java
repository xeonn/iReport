 ...
 */
public final class CandlestickTimeAxisLabelColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_COLOR, java.awt.Color.class,
              "Time Axis Label Color",
              "The color of the Time Axis Label.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnTimeAxisLabelColor();
            Color newValue =  (Color)val;
            element.setTimeAxisLabelColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnTimeAxisLabelColor();
    }
