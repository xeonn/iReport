...
public final class ScatterXAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public ScatterXAxisLabelExpressionProperty(JRDesignScatterPlot element, JRDesignDataset dataset)
    {
        super(JRDesignScatterPlot.PROPERTY_X_AXIS_LABEL_EXPRESSION,
              "X Axis Label Expression",
              "X Axis Label Expression");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        if (element.getXAxisLabelExpression() == null) return "";
        return element.getXAxisLabelExpression().getText();
    }

    @Override
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {

        JRDesignExpression oldExp =  (JRDesignExpression)element.getXAxisLabelExpression();
        JRDesignExpression newExp = null;
        //System.out.println("Setting as value: " + val);
        if (val == null || val.equals(""))
        {
            element.setXAxisLabelExpression(null);
        }
        else
        {
            ...
            element.setXAxisLabelExpression(newExp);
        }
    ...
    public boolean isDefaultValue() {
        return element.getXAxisLabelExpression() == null || 
               element.getXAxisLabelExpression().getText() == null ||
               element.getXAxisLabelExpression().getText().length() == 0;
    }
