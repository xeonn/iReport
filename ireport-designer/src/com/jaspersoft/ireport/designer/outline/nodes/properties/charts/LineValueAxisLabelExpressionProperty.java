...
public final class LineValueAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public LineValueAxisLabelExpressionProperty(JRDesignLinePlot element, JRDesignDataset dataset)
    {
        super(JRDesignLinePlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION,
