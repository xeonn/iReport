 ...
 */
public final class BarShowTickMarksProperty extends PropertySupport.ReadWrite {

    private final JRDesignBarPlot element;

    @SuppressWarnings("unchecked")
    public BarShowTickMarksProperty(JRDesignBarPlot element)
    {
        super(JRDesignBarPlot.PROPERTY_SHOW_TICK_MARKS, Boolean.class,
              "Show Tick Marks",
              "Show Tick Marks");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        return element.isShowTickMarks();
    }
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (val instanceof Boolean)
        {
            ...
            element.setShowTickMarks(newValue);
