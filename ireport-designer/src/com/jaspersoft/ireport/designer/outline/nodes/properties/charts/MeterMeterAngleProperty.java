 ...
 */
public final class MeterMeterAngleProperty extends PropertySupport.ReadWrite {

    JRDesignMeterPlot element = null;

    @SuppressWarnings("unchecked")
    public MeterMeterAngleProperty(JRDesignMeterPlot element)
    {
        super(JRDesignMeterPlot.PROPERTY_METER_ANGLE, Integer.class,
              "Meter Angle",
              "Meter Angle");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            int oldValue = element.getMeterAngle();
            int newValue =  ((Integer)val).intValue();
            
            element.setMeterAngle(newValue);
