 ...
 */
public final class TimeSeriesShowShapesProperty extends PropertySupport.ReadWrite {

    private final JRDesignTimeSeriesPlot element;

    @SuppressWarnings("unchecked")
    public TimeSeriesShowShapesProperty(JRDesignTimeSeriesPlot element)
    {
        super(JRDesignTimeSeriesPlot.PROPERTY_SHOW_SHAPES, Boolean.class,
              "Show Shapes",
              "Show Shapes");
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowShapes();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowShapes(newValue);
