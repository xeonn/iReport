...
public final class ThermometerMediumDataRangeLowExpressionProperty extends ExpressionProperty {
    ...
    public ThermometerMediumDataRangeLowExpressionProperty(JRDesignThermometerPlot element, JRDesignDataset dataset)
    {
        super("MEDIUM_RANGE_" + JRDesignDataRange.PROPERTY_LOW_EXPRESSION,
              "Medium Data Range Low Expression",
              "Medium Data Range Low Expression");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        ...
        if (element.getMediumRange().getLowExpression() == null) return "";
        if (element.getMediumRange().getLowExpression().getText() == null) return "";
        return element.getMediumRange().getLowExpression().getText();
    }
