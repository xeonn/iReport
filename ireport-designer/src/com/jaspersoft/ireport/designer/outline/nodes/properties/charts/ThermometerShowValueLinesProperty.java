 ...
 */
public final class ThermometerShowValueLinesProperty extends PropertySupport.ReadWrite {

    private final JRDesignThermometerPlot element;

    @SuppressWarnings("unchecked")
    public ThermometerShowValueLinesProperty(JRDesignThermometerPlot element)
    {
        super(JRDesignThermometerPlot.PROPERTY_SHOW_VALUE_LINES, Boolean.class,
              "Show Value Lines",
              "Show Value Lines");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        return element.isShowValueLines();
    }
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowValueLines();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowValueLines(newValue);
