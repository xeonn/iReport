 ...
 */
public final class BubbleYAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignBubblePlot element;
        
        @SuppressWarnings("unchecked")
        public BubbleYAxisTickLabelFontProperty(JRDesignBubblePlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignBubblePlot.PROPERTY_Y_AXIS_TICK_LABEL_FONT, "Y Axis Tick Label Font", "Y Axis Tick Label Font", jd);
