 ...
 */
public final class ScatterXAxisLabelColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignScatterPlot.PROPERTY_X_AXIS_LABEL_COLOR, java.awt.Color.class,
              "X Axis Label Color",
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnXAxisLabelColor();
            Color newValue =  (Color)val;
            element.setXAxisLabelColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnXAxisLabelColor();
    }
