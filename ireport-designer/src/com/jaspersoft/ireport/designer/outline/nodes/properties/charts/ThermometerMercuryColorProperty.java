 ...
 */
public final class ThermometerMercuryColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super( JRDesignThermometerPlot.PROPERTY_MERCURY_COLOR, java.awt.Color.class,
              "Mercury Color",
              "The color of the mercury inside the thermometer.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getMercuryColor();
            Color newValue =  (Color)val;
            element.setMercuryColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getMercuryColor();
    }
