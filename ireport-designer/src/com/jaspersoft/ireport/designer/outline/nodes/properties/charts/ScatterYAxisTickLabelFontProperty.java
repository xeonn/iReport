 ...
 */
public final class ScatterYAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignScatterPlot element;
        
        @SuppressWarnings("unchecked")
        public ScatterYAxisTickLabelFontProperty(JRDesignScatterPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignScatterPlot.PROPERTY_Y_AXIS_TICK_LABEL_FONT, "Y Axis Tick Label Font", "Y Axis Tick Label Font", jd);
    ...
    @Override
        public Object getValue() throws IllegalAccessException, InvocationTargetException {
            return element.getYAxisTickLabelFont();
        }
    ...
    @Override
        public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            {
                JRDesignFont oldValue = (JRDesignFont)element.getYAxisTickLabelFont();
                JRDesignFont newValue = (JRDesignFont)val;
                element.setYAxisTickLabelFont(newValue);
        ...
        public boolean isDefaultValue() {
            return null == element.getYAxisTickLabelFont();
        }
