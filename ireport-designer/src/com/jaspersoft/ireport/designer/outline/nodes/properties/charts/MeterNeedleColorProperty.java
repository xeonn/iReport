 ...
 */
public final class MeterNeedleColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super( JRDesignMeterPlot.PROPERTY_NEEDLE_COLOR, java.awt.Color.class,
              "Needle Color",
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getNeedleColor();
            Color newValue =  (Color)val;
            element.setNeedleColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getNeedleColor();
    }
