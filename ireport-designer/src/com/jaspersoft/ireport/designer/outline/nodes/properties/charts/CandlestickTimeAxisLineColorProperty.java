 ...
 */
public final class CandlestickTimeAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LINE_COLOR, java.awt.Color.class,
              "Time Axis Candlestick Color",
              "The color of the Time Axis Candlestick.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnTimeAxisLineColor();
            Color newValue =  (Color)val;
            element.setTimeAxisLineColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnTimeAxisLineColor();
    }
