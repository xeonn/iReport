 ...
 */
public final class AreaValueAxisLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignAreaPlot element;
        
        @SuppressWarnings("unchecked")
        public AreaValueAxisLabelFontProperty(JRDesignAreaPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignAreaPlot.PROPERTY_VALUE_AXIS_LABEL_FONT, "Value Axis Label Font", "Value Axis Label Font", jd);
