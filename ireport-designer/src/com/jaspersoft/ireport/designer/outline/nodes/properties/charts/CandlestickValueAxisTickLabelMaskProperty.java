 ...
 */
public final class CandlestickValueAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignCandlestickPlot element;
    
        @SuppressWarnings("unchecked")
        public CandlestickValueAxisTickLabelMaskProperty(JRDesignCandlestickPlot element)
        {
            super(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK,
                    String.class, 
