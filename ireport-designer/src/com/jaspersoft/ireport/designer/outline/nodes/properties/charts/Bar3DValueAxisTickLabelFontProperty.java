 ...
 */
public final class Bar3DValueAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignBar3DPlot element;
        
        @SuppressWarnings("unchecked")
        public Bar3DValueAxisTickLabelFontProperty(JRDesignBar3DPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, "Value Axis Tick Label Font", "Value Axis Tick Label Font", jd);
