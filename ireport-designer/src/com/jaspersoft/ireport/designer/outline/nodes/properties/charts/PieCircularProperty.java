 ...
 */
public final class PieCircularProperty extends PropertySupport.ReadWrite {

    private final JRDesignPiePlot element;

    @SuppressWarnings("unchecked")
    public PieCircularProperty(JRDesignPiePlot element)
    {
