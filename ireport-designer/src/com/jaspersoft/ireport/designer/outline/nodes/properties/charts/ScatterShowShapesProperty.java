 ...
 */
public final class ScatterShowShapesProperty extends PropertySupport.ReadWrite {

    private final JRDesignScatterPlot element;

    @SuppressWarnings("unchecked")
    public ScatterShowShapesProperty(JRDesignScatterPlot element)
    {
        super(JRDesignScatterPlot.PROPERTY_SHOW_SHAPES, Boolean.class,
              "Show Shapes",
              "Show Shapes");
