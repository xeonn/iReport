 ...
 */
public final class MeterMeterBackgroundColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super( JRDesignMeterPlot.PROPERTY_METER_BACKGROUND_COLOR, java.awt.Color.class,
              "Meter Background",
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getMeterBackgroundColor();
            Color newValue =  (Color)val;
            element.setMeterBackgroundColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getMeterBackgroundColor();
    }
