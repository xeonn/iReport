 ...
 */
public final class LineValueAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignLinePlot element;
    
        @SuppressWarnings("unchecked")
        public LineValueAxisTickLabelMaskProperty(JRDesignLinePlot element)
        {
            super(JRDesignLinePlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK,
                    String.class, 
