 ...
 */
public final class CandlestickValueAxisTickLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignCandlestickPlot element;
        
        @SuppressWarnings("unchecked")
        public CandlestickValueAxisTickLabelFontProperty(JRDesignCandlestickPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, "Value Axis Tick Label Font", "Value Axis Tick Label Font", jd);
