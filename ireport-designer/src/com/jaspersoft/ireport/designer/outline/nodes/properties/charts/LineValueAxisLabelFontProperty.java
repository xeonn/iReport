 ...
 */
public final class LineValueAxisLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignLinePlot element;
        
        @SuppressWarnings("unchecked")
        public LineValueAxisLabelFontProperty(JRDesignLinePlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignLinePlot.PROPERTY_VALUE_AXIS_LABEL_FONT, "Value Axis Label Font", "Value Axis Label Font", jd);
