 ...
 */
public final class AreaCategoryAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignAreaPlot.PROPERTY_CATEGORY_AXIS_LINE_COLOR, java.awt.Color.class,
              "Category Axis Area Color",
              "The color of the Category Axis Area.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnCategoryAxisLineColor();
            Color newValue =  (Color)val;
            element.setCategoryAxisLineColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnCategoryAxisLineColor();
    }
