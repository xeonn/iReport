 ...
 */
public final class Bar3DCategoryAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignBar3DPlot element;
    
        @SuppressWarnings("unchecked")
        public Bar3DCategoryAxisTickLabelMaskProperty(JRDesignBar3DPlot element)
        {
            super(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_MASK,
                    String.class, 
