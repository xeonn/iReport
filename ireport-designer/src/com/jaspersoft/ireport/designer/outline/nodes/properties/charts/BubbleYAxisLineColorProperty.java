 ...
 */
public final class BubbleYAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignBubblePlot.PROPERTY_Y_AXIS_LINE_COLOR, java.awt.Color.class,
              "Y Axis Bubble Color",
              "The color of the Y Axis Bubble.");
