 ...
 */
public final class ScatterXAxisTickLabelColorProperty extends PropertySupport.ReadWrite {

    JRDesignScatterPlot element = null;

    @SuppressWarnings("unchecked")
    public ScatterXAxisTickLabelColorProperty(JRDesignScatterPlot element)
    {
        super(JRDesignScatterPlot.PROPERTY_X_AXIS_TICK_LABEL_COLOR, java.awt.Color.class,
              "X Axis Tick Label Color",
              "The color of the X Axis Tick Label.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnXAxisTickLabelColor();
            Color newValue =  (Color)val;
            element.setXAxisTickLabelColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnXAxisTickLabelColor();
    }
