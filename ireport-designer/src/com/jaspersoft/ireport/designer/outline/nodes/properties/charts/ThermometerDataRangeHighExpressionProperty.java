...
public final class ThermometerDataRangeHighExpressionProperty extends ExpressionProperty {
    ...
    public ThermometerDataRangeHighExpressionProperty(JRDesignThermometerPlot element, JRDesignDataset dataset)
    {
        super(JRDesignDataRange.PROPERTY_HIGH_EXPRESSION,
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        ...
        if (element.getDataRange().getHighExpression() == null) return "";
        if (element.getDataRange().getHighExpression().getText() == null) return "";
        return element.getDataRange().getHighExpression().getText();
    }
