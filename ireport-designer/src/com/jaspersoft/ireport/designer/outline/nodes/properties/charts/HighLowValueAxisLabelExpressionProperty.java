...
public final class HighLowValueAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public HighLowValueAxisLabelExpressionProperty(JRDesignHighLowPlot element, JRDesignDataset dataset)
    {
        super(JRDesignHighLowPlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION,
