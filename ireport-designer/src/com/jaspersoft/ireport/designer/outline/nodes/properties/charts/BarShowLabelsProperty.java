 ...
 */
public final class BarShowLabelsProperty extends PropertySupport.ReadWrite {

    private final JRDesignBarPlot element;

    @SuppressWarnings("unchecked")
    public BarShowLabelsProperty(JRDesignBarPlot element)
    {
        super(JRDesignBarPlot.PROPERTY_SHOW_LABELS, Boolean.class,
              "Show Labels",
              "Show Labels");
