 ...
 */
public final class HighLowShowCloseTicksProperty extends PropertySupport.ReadWrite {

    private final JRDesignHighLowPlot element;

    @SuppressWarnings("unchecked")
    public HighLowShowCloseTicksProperty(JRDesignHighLowPlot element)
    {
        super(JRDesignHighLowPlot.PROPERTY_SHOW_CLOSE_TICKS, Boolean.class,
              "Show Close Ticks",
              "Show Close Ticks");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        return element.isShowCloseTicks();
    }
    ...
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        {
            boolean oldValue = element.isShowCloseTicks();
            boolean newValue =   ((Boolean)val).booleanValue();
            element.setShowCloseTicks(newValue);
