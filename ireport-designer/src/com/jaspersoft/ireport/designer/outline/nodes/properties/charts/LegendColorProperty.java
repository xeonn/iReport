 ...
 */
public final class LegendColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRBaseChart.PROPERTY_LEGEND_COLOR, java.awt.Color.class,
              "Legend Color",
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnLegendColor();
            Color newValue =  (Color)val;
            element.setLegendColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnLegendColor();
    }
