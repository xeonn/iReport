 ...
 */
public final class LegendFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignChart element;
        
        @SuppressWarnings("unchecked")
        public LegendFontProperty(JRDesignChart element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignChart.PROPERTY_LEGEND_FONT, "Legend font", "Legend font", jd);
    ...
    @Override
        public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            {
                JRDesignFont oldValue = (JRDesignFont)element.getLegendFont();
                JRDesignFont newValue = (JRDesignFont)val;
                element.setLegendFont(newValue);
        ...
        public boolean isDefaultValue() {
            return null == element.getLegendFont();
        }
