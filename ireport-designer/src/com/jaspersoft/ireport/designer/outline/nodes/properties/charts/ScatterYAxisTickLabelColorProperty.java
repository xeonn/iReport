 ...
 */
public final class ScatterYAxisTickLabelColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignScatterPlot.PROPERTY_Y_AXIS_TICK_LABEL_COLOR, java.awt.Color.class,
              "Y Axis Tick Label Color",
              "The color of the Y Axis Tick Label.");
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnYAxisTickLabelColor();
            Color newValue =  (Color)val;
            element.setYAxisTickLabelColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnYAxisTickLabelColor();
    }
