 ...
 */
public final class ScatterXAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignScatterPlot.PROPERTY_X_AXIS_LINE_COLOR, java.awt.Color.class,
              "X Axis Scatter Color",
              "The color of the X Axis Scatter.");
