...
public final class ScatterYAxisLabelExpressionProperty extends ExpressionProperty {
    ...
    public ScatterYAxisLabelExpressionProperty(JRDesignScatterPlot element, JRDesignDataset dataset)
    {
        super(JRDesignScatterPlot.PROPERTY_Y_AXIS_LABEL_EXPRESSION,
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        if (element.getYAxisLabelExpression() == null) return "";
        return element.getYAxisLabelExpression().getText();
    }

    @Override
    public void setValue(Object val) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {

        JRDesignExpression oldExp =  (JRDesignExpression)element.getYAxisLabelExpression();
        JRDesignExpression newExp = null;
        //System.out.println("Setting as value: " + val);
        if (val == null || val.equals(""))
        {
            element.setYAxisLabelExpression(null);
        }
        else
        {
            ...
            element.setYAxisLabelExpression(newExp);
        }
    ...
    public boolean isDefaultValue() {
        return element.getYAxisLabelExpression() == null || 
               element.getYAxisLabelExpression().getText() == null ||
               element.getYAxisLabelExpression().getText().length() == 0;
    }
