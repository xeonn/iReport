 ...
 */
public final class CandlestickValueAxisLabelFontProperty extends JRFontProperty
{
        private final JasperDesign jd;
        private final JRDesignCandlestickPlot element;
        
        @SuppressWarnings("unchecked")
        public CandlestickValueAxisLabelFontProperty(JRDesignCandlestickPlot element, JasperDesign jd)
        {
            // TODO: Replace WhenNoDataType with the right constant
            super( JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_FONT, "Value Axis Label Font", "Value Axis Label Font", jd);
