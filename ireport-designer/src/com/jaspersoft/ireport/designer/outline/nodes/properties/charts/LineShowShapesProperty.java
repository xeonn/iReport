 ...
 */
public final class LineShowShapesProperty extends PropertySupport.ReadWrite {

    private final JRDesignLinePlot element;

    @SuppressWarnings("unchecked")
    public LineShowShapesProperty(JRDesignLinePlot element)
    {
        super(JRDesignLinePlot.PROPERTY_SHOW_SHAPES, Boolean.class,
              "Show Shapes",
              "Show Shapes");
