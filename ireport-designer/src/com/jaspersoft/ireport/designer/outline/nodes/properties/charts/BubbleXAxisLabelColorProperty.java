 ...
 */
public final class BubbleXAxisLabelColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignBubblePlot.PROPERTY_X_AXIS_LABEL_COLOR, java.awt.Color.class,
              "X Axis Label Color",
