 ...
 */
public final class Bar3DValueAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignBar3DPlot element;
    
        @SuppressWarnings("unchecked")
        public Bar3DValueAxisTickLabelMaskProperty(JRDesignBar3DPlot element)
        {
            super(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK,
                    String.class, 
