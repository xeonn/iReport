 ...
 */
public final class LineCategoryAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignLinePlot element;
    
        @SuppressWarnings("unchecked")
        public LineCategoryAxisTickLabelMaskProperty(JRDesignLinePlot element)
        {
            super(JRDesignLinePlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_MASK,
                    String.class, 
