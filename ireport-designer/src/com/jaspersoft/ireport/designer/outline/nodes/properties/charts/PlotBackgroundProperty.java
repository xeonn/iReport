 ...
 */
public final class PlotBackgroundProperty extends PropertySupport.ReadWrite {

    JRBaseChartPlot element = null;

    @SuppressWarnings("unchecked")
    public PlotBackgroundProperty(JRBaseChartPlot element)
    {
        super(JRBaseChartPlot.PROPERTY_BACKCOLOR, java.awt.Color.class,
              "Background",
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getOwnBackcolor();
            Color newValue =  (Color)val;
            element.setBackcolor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getOwnBackcolor();
    }
