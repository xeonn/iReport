 ...
 */
public final class HighLowTimeAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignHighLowPlot.PROPERTY_TIME_AXIS_LINE_COLOR, java.awt.Color.class,
              "Time Axis HighLow Color",
              "The color of the Time Axis HighLow.");
