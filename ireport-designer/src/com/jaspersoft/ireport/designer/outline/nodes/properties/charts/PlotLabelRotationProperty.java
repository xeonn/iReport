 ...
 */
public final class PlotLabelRotationProperty extends PropertySupport.ReadWrite {

    JRBaseChartPlot element = null;

    @SuppressWarnings("unchecked")
    public PlotLabelRotationProperty(JRBaseChartPlot element)
    {
        super(JRBaseChartPlot.PROPERTY_LABEL_ROTATION, Double.class,
              "Label rotation",
              "Label rotation");
    ...
    public Object getValue() throws IllegalAccessException, InvocationTargetException {
        return element.getLabelRotation();
    }
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            double oldValue = element.getLabelRotation();
            double newValue =  ((Double)val).doubleValue();
            
            element.setLabelRotation(newValue);
