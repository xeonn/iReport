 ...
 */
public final class LineValueAxisLineColorProperty extends PropertySupport.ReadWrite {
    ...
    {
        super(JRDesignLinePlot.PROPERTY_VALUE_AXIS_LINE_COLOR, java.awt.Color.class,
              "Value Axis Line Color",
              "The color of the Value Axis Line.");
