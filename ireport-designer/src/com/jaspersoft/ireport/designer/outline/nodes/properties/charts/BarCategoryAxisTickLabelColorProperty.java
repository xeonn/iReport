 ...
 */
public final class BarCategoryAxisTickLabelColorProperty extends PropertySupport.ReadWrite {

    JRDesignBarPlot element = null;

    @SuppressWarnings("unchecked")
    public BarCategoryAxisTickLabelColorProperty(JRDesignBarPlot element)
    {
        super(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_COLOR, java.awt.Color.class,
