 ...
 */
public final class MeterTickColorProperty extends PropertySupport.ReadWrite {
    ...
    private void setPropertyValue(Object val)
    {
        ...
        {
            Color oldValue = element.getTickColor();
            Color newValue =  (Color)val;
            element.setTickColor(newValue);
    ...
    public boolean isDefaultValue() {
        return null == element.getTickColor();
    }
