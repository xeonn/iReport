 ...
 */
public final class TimeSeriesValueAxisTickLabelMaskProperty extends PropertySupport
{
        private final JRDesignTimeSeriesPlot element;
    
        @SuppressWarnings("unchecked")
        public TimeSeriesValueAxisTickLabelMaskProperty(JRDesignTimeSeriesPlot element)
        {
            super(JRDesignTimeSeriesPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK,
                    String.class, 
