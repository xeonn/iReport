...
public class QueryExecuterDialog extends javax.swing.JDialog {
    ...
    public QueryExecuterDialog(Dialog parent, boolean modal) 
    {
         super(parent,modal);
         initAll();
    }
    ...
    public QueryExecuterDialog(Frame parent, boolean modal) 
    {
         super(parent,modal);
         initAll();
    }
    ...
    private void initComponents() {
        ...
        setTitle(I18n.getString("QueryExecuterDialog.Title.AddModProperty")); // NOI18N
        setModal(true);
        ...
        jLabel1.setText(I18n.getString("QueryExecuterDialog.Label.Language")); // NOI18N
        ...
        jLabel4.setText(I18n.getString("QueryExecuterDialog.Label.FactoryClass")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabelFieldsProvider.setText(I18n.getString("QueryExecuterDialog.Label.FieldsProv")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        ...
        if (this.jTextFieldLanguage.getText().trim().length() <= 0)
        {
            javax.swing.JOptionPane.showMessageDialog(this,
                    //I18n.getString("messages.queryExecuterDialog.notValidLanguage",
                    I18n.getString("QueryExecuterDialog.Message.Warning"),
                    //I18n.getString("messages.queryExecuterDialog.notValidLanguageCaption",
                    I18n.getString("QueryExecuterDialog.Message.Error"),javax.swing.JOptionPane.WARNING_MESSAGE );
            return;
        }
        ...
        {
            javax.swing.JOptionPane.showMessageDialog(this,
                    //I18n.getString("messages.queryExecuterDialog.notValidFactoryName",
                    I18n.getString("QueryExecuterDialog.Message.Warning2"),
                    //I18n.getString("messages.queryExecuterDialog.notValidFactoryNameCaption",
                    I18n.getString("QueryExecuterDialog.Message.Error2"),
