...
public class OlapBrowser extends javax.swing.JPanel implements FieldsProviderEditor {
    ...
    public OlapBrowser() {
        ...
        jComboBoxType.addItem(new Tag("java.lang.String","Text"));
        jComboBoxType.addItem(new Tag("java.lang.Number", "Numeric"));
        jComboBoxType.addItem(new Tag("java.util.Date", "Date"));
        jComboBoxType.addItem(new Tag("java.util.Date", "Boolean"));
