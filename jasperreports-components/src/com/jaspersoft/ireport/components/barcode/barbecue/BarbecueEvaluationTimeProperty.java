...
public class BarbecueEvaluationTimeProperty extends PropertySupport {
    ...
    public BarbecueEvaluationTimeProperty(StandardBarbecueComponent component, JRDesignDataset dataset)
    {
        ...
        super( StandardBarbecueComponent.PROPERTY_EVALUATION_TIME,EvaluationTimeEnum.class, I18n.getString("Global.Property.EvaluationTime"), I18n.getString("Global.Property.EvaluationTimedetail"), true, true);
