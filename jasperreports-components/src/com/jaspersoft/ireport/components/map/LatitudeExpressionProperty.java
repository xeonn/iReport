 ...
 */
public final class LatitudeExpressionProperty extends ExpressionProperty 
{
    private final StandardMapComponent component;

    public LatitudeExpressionProperty(StandardMapComponent component, JRDesignDataset dataset)
    {
    ...
    {
        return StandardMapComponent.PROPERTY_LATITUDE_EXPRESSION;
    }
