...
/*
 * ListDatasetRunPanel.java
 *
 * Created on 24-apr-2009, 10.24.04
 */
 ...
 * @author gtoffoli
 */
public class ListDatasetRunPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jPanel1.border.title"))); // NOI18N
        jPanel1.setPreferredSize(new java.awt.Dimension(329, 192));
        jPanel1.setLayout(new java.awt.GridBagLayout());

        jLabelIncrementType1.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jLabelIncrementType1.text")); // NOI18N
        ...
        jLabel41.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jLabel41.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jTabbedPaneSubDataset.addTab(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jPanel6.TabConstraints.tabTitle"), jPanel6); // NOI18N
        ...
        jButtonAddParameter.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jButtonAddParameter.text")); // NOI18N
        ...
        jButtonModParameter.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jButtonModParameter.text")); // NOI18N
        ...
        jButtonRemParameter.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jButtonRemParameter.text")); // NOI18N
        ...
        jTabbedPaneSubDataset.addTab(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jPanel4.TabConstraints.tabTitle"), jPanel4); // NOI18N

        jPanel5.setLayout(new java.awt.GridBagLayout());

        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel26.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jLabel26.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        ...
        jTabbedPaneSubDataset.addTab(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jPanel5.TabConstraints.tabTitle"), jPanel5); // NOI18N
        ...
        jButtonOk.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jButtonOk.text")); // NOI18N
        ...
        jButtonCancel.setText(org.openide.util.NbBundle.getMessage(ListDatasetRunPanel.class, "ListDatasetRunPanel.jButtonCancel.text")); // NOI18N
